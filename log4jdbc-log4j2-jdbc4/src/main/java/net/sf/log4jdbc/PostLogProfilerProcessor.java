 ...
 *
 * <h3>Update for log4jdbc-log4j2</h3>: 
 * This class has not been updated. It will for sure not work when the log4j2 logger is used, 
 * and is not guarantee to continue to work when using Slf4j.
 */
